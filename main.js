...
var Duration = class {
  ...
  toMillis() {
    ...
    for (let unit of reverseUnits.slice(1)) {
      if ((_b = this.values) == null ? void 0 : _b[unit]) {
...
function getRewriteRules2(pathRewriteRules) {
...
function getGardenPathForNote2(vaultPath, rules) {
...
var Publisher = class {
  constructor(vault, metadataCache, settings) {
    ...
    this.rewriteRules = getRewriteRules2(settings.pathRewriteRules);
  }
  ...
  generateMarkdown(file) {
    return __async(this, null, function* () {
      this.rewriteRules = getRewriteRules2(this.settings.pathRewriteRules);
      const assets = { images: [] };
...
`;
  ...
  addPermalink(baseFrontMatter, newFrontMatter, filePath) {
    const publishedFrontMatter = __spreadValues({}, newFrontMatter);
    const gardenPath = baseFrontMatter && baseFrontMatter["dg-path"] ? baseFrontMatter["dg-path"] : getGardenPathForNote2(filePath, this.rewriteRules);
...
` : "";
              ...
              if (publishedFiles.find((f) => f.path == linkedFile.path)) {
                embedded_link = `<a class="markdown-embed-link" href="/${generateUrlPath(getGardenPathForNote2(linkedFile.path, this.rewriteRules))}${sectionID}" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a>`;
              }
              fileText = `
...
${key}=${defaultNoteSettings[key]}`;
  ...
  getNoteUrl(file) {
    ...
    const noteUrlPath = generateUrlPath(getGardenPathForNote2(file.path, this.rewriteRules), this.settings.slugifyEnabled);
